...
coco128 = open('yolov8/coco128.txt', 'r')
data = coco128.read()
...
while True:
    ...
    detection = model.predict(frame_tensor, conf=CONFIDENCE_THRESHOLD)[0]
    detection = detection.cpu()  # Move detections back to CPU for further processing
